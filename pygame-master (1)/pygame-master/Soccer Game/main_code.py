...
def pause_menu():
    ...
    draw_text_with_shadow(screen, pause_text, font, WHITE, (545, 360), None, shadow_color, shadow_offset)
    draw_text_with_shadow(screen, title_text, font, WHITE, (480, 250), None, shadow_color, shadow_offset)
    draw_text_with_shadow(screen, reset_text, font, RED, (500, 470), resetGame, shadow_color, shadow_offset)
